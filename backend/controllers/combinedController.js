...
exports.getCombinedData = void 0;
...
const getCombinedData = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const [transactions, statistics, barChart, pieChart] = yield Promise.all([
            transactionService.getTransactions(month, '', 1),
            transactionService.getMonthStatistics(month),
